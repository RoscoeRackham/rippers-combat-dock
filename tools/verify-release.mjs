...
// Checks: TWO-ASSET RULE (assets named exactly module.json + rippers-combat-dock.zip — a missing/mis-named
...
const REPO = 'RoscoeRackham/rippers-combat-dock';
const ID = 'rippers-combat-dock';
